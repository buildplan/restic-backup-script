...
2.  Add the following lines to schedule your backups and maintenance. 
    ...
    ```
    *For pune job in your `restic-backup.conf`, set `PRUNE_AFTER_FORGET=true`.*<br>
    *For more details on how forget flag work, see the [official Restic documentation on removing snapshots](https://restic.readthedocs.io/en/stable/060_forget.html).*<br>
